...
<script>
import SideMenu from './components/SideMenu.vue'; //引入侧边栏
import BreadCrumb from './components/BreadCrumb.vue'; //引入面包屑导航
...
import OperationMenu from './components/OperationMenu.vue';     //创建文件夹
import FileUploader from './components/FileUploader.vue';     //上传文件
